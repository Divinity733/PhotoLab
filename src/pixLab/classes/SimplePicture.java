...
/**
 * A class that represents a simple picture. A simple picture may have an associated file name and a title. A simple picture has pixels, width, and height. A simple picture uses a BufferedImage to hold the pixels. You can show a simple picture in a PictureFrame (a JFrame). You
 * can also explore a simple picture.
 * 
...
public class SimplePicture implements DigitalPicture
{
	...
	/**
	 * A Constructor that takes no arguments. It creates a picture with a width of 200 and a height of 100 that is all white. A no-argument constructor must be given in order for a class to be able to be subclassed. By default all subclasses will implicitly call this in their
	 * parent's no-argument constructor unless a different call to super() is explicitly made as the first line of code in a constructor.
	 */
	 ...
	 * 
	 * @return a one-dimensional array of Pixel objects starting with y=0 to y=height-1 and x=0 to x=width-1.
	 */
