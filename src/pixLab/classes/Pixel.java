...
/**
 * Class that references a pixel in a picture. Pixel stands for picture element where picture is abbreviated pix. A pixel has a column (x) and row (y) location in a picture. A pixel knows how to get and set the red, green, blue, and alpha values in the picture. A pixel also knows
...
public class Pixel
{
	...
	public int getAlpha()
	{
		...
		/*
		 * get the value at the location from the picture as a 32 bit int with alpha, red, green, blue each taking 8 bits from left to right
		 */
